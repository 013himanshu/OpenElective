...
<html>
	<head>
		<title>Subject Allotment | Admin | MUJ OE &amp; HE</title>
		<meta charset="utf-8">
...
<div style="padding: 8px;">
	<div class="container white-sheet" style="padding: 0px;">
		<h1 class="white-sheet-title text-center">Allotment</h1>
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 alot-data-table-box" style="padding: 0px;">
				<!--Allotment List-->
